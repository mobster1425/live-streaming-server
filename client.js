...
let peerConnections = {}; // Object to store RTCPeerConnection instances
let currentStreamId = null; // ID of the current stream
...
function connectSocket() {
    ...
    // Event listener for new streams starting
    ...
    // Event listener for streams stopping
...
/**
 * Starts the local media stream (audio and video)
 */
...
/**
 * Creates a new RTCPeerConnection for a given target
